<template>
    <div class="user-order-list">
        ...
        <div class="custom-card margin-bottom-20">
            <h1 class="card-title margin-bottom-20">
                <span class="order-status-title" :class="{active: status === 'all'}" @click="status = 'all'">全部订单<span class="status-separate">/</span></span>
                <span class="order-status-title" :class="{active: status === 'pending'}" @click="status = 'pending'">待确认<span class="status-separate">/</span></span>
                <span class="order-status-title" :class="{active: status === 'success'}" @click="status = 'success'">已完成<span class="status-separate">/</span></span>
                <span class="order-status-title" :class="{active: status === 'cancle'}" @click="status = 'cancle'">已取消<span class="status-separate"></span></span>
            </h1>
