<template>
  <div class="user-center-page travel-manage-carouse">
    ...
    <div class="custom-card margin-bottom-20">
      <h1 class="card-title"><span>轮播图</span><span class="pull-right" @click="modal = true">添加</span></h1>
      <div class="card-box">
            <div class="custom-card margin-bottom-20">
                <h1 class="card-title text-center"><span class="title pull-left">标题</span><span class="order">排序</span><span class="operate pull-right">操作</span></h1>
                <div class="card-box">
                    <div class="carouse-item">
                        <div class="carouse-info">
                            <img class="carouse-image" src="http://via.placeholder.com/80x80">
                            <p class="carouse-text">大西洋号东莞出发深圳往返 深圳太子湾大西洋号东莞出发深圳往返 深圳太子湾</p>
                        </div>
                        <div class="carouse-order">20</div>
                        <div class="carouse-oprate"><span class="carouse-edit" @click="modal = true">编辑</span><span class="carouse-delete">删除</span></div>
                    </div>
                </div>
            </div>
      </div>
