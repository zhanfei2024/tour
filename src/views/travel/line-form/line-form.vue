                ...
                <div class="custom-card margin-top-20 margin-bottom-20">
                    ...
                    <div class="card-box">
                        ...
                        <div class="custom-card product-info">
                            ...
                            <div class="card-box">
                                <Form v-for="form in selectTravelForm" :key="form.formId" ref="travelForm" :model="form.travelForm" :rules="form.travelValidate" :label-width="80">
                                    <FormItem label="姓名" prop="name">
                                        <Input v-model="form.travelForm.name" placeholder="Enter your name"></Input>
                                    </FormItem>
                                    <FormItem label="证件类型" prop="idType">
                                        <Select v-model="form.travelForm.idType" placeholder="Select your id">
                                    ...
                                    <FormItem label="证件号码" prop="idNum">
                                        <Input v-model="form.travelForm.idNum" placeholder="Enter your id number"></Input>
                                    </FormItem>
                                    <FormItem label="手机号" prop="phone">
                                        <Input v-model="form.travelForm.phone" placeholder="Enter your phone"></Input>
                                    </FormItem>
                                </Form>
                            </div>
                        </div>
...
export default {
  ...
  watch: {
      selectNum: function (newSelectNum, oldSelectNum) {
          console.log(newSelectNum, oldSelectNum)
          this.selectTravelForm.push(this.Form)
      }
  },
  components: {
